...
"""[1:-1].split('\n') #初めの改行をカット
    ...
    def test_remove_negation_from_naide_kudasai2(self):
        token_lines = """
...
"""[1:-1].split('\n') #初めの改行をカット
        ...
        actual = replace_lib.remove_negation_from_naide_kudasai(token_lines)
        expected = ['忘れ わすれ 忘れる 動詞 * * * 母音動詞 * 基本連用形 * "代表表記:忘れる/わすれる 付属動詞候補（基本） 反義:動詞:覚える/おぼえる" <代表表記:忘れる/わすれる><付属動詞候補（基本）><反義:動詞:覚える/おぼえる><正規化代表表記:忘れる/わすれる><文頭><かな漢字><活用語><自立><内容語><タグ単位始><文節始><文節主辞>', 'ましょう ましょう ます 接尾辞 14 動詞性接尾辞 7 動詞性接尾辞ます型 31 意志形 4 "代表表記:ます/ます"']
        self.assertEquals(actual, expected)

    def test_remove_negation_from_naide_kudasai3(self):
        token_lines = """
...
"""[1:-1].split('\n') #初めの改行をカット
        ...
        actual = replace_lib.remove_negation_from_naide_kudasai(token_lines)
        expected = ['覚え おぼえ 覚える 動詞 * * * 母音動詞 * 基本連用形 * "代表表記:覚える/おぼえる 反義:動詞:忘れる/わすれる" <代表表記:覚える/おぼえる><反義:動詞:忘れる/わすれる><正規化代表表記:覚える/おぼえる><文頭><かな漢字><活用語><自立><内容語><タグ単位始><文節始><文節主辞>', 'ましょう ましょう ます 接尾辞 14 動詞性接尾辞 7 動詞性接尾辞ます型 31 意志形 4 "代表表記:ます/ます"']
        self.assertEquals(actual, expected)
